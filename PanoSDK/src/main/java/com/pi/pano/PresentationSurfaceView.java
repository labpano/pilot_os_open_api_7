    ...
    public PresentationSurfaceView(Context context, AttributeSet attrs, final PanoSurfaceView relateSurfaceView) {
        ...
        getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                relateSurfaceView.mPiPano.setEncodeSurface(holder.getSurface(), PiEncodeSurfaceType.PRESENTATION);
            }
            ...
            public void surfaceDestroyed(SurfaceHolder holder) {
                relateSurfaceView.mPiPano.setEncodeSurface(null, PiEncodeSurfaceType.PRESENTATION);
            }
        });
    }
}
