...
public class SurfaceSizeUtils {
    ...
    public static int[] calculateSurfaceSize(int containerWidth, int containerHeight, String aspectRatio) {
        int[] ret = new int[2];
        return calculateSurfaceSize(containerWidth, containerHeight, aspectRatio, ret);
    }

    @NonNull
    public static int[] calculateSurfaceSize(int containerWidth, int containerHeight, String aspectRatio, @NonNull int[] ret) {
